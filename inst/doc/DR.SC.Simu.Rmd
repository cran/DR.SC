...
First, we analyze  a simulated spatial transcriptomics data from ST platform, which is a Seurat object format. It is noted that the `meta.data` must include spatial coordinates in columns named "row" (x coordinates) and "col" (y coordinates)! This data is available [here](https://github.com/feiyoung/DR-SC.Analysis/tree/main/data/).
```{r   eval = FALSE}
load('sim_seu.rds')
library(DR.SC)
head(seu@meta.data)
